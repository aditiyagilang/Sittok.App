...
Future<void> fetchData() async {
  ...
  Widget build(BuildContext context) {
      String imageUrl = "https://fd01-202-154-18-72.ngrok-free.app/" + dataimage.profil.toString();
    return SizedBox(
      height: 115,
      width: 115,
      child: Stack(
...
Future<void> _handlephoto() async {
 ...
 if (image == null) {
  ...
  var request = http.MultipartRequest('POST', Uri.parse(ApiConnect.updateprofil));
  request.fields['id_customer'] = idCustomerString;
  request.files.add(await http.MultipartFile.fromPath("profil", image!.path));
